...
class DrawingView(context: Context, attr: AttributeSet) : View(context, attr) {
    ...
    override fun onSizeChanged(w: Int, h: Int, oldw: Int, oldh: Int) {
        ...
        mCanvasBitmap = Bitmap.createBitmap(w, h, Bitmap.Config.ARGB_8888)      //Create an area to draw
    ...
    override fun onTouchEvent(event: MotionEvent?): Boolean {
        ...
        when(event?.action){
            MotionEvent.ACTION_DOWN -> {
                ...
                if (eventX != null) {
                    mDrawPath!!.moveTo(eventX, eventY!!)  // can be written as eventX when null check is given or as eventX!!
                }
